...
public class Address {
    ...
    @Column(name="a_id")   // //here we are changing the name of column and this column will appear in s1l database ans sql workbench
	...
	@Column(length =50, name="street")  //here we are changing the length of column by 50,the default size of string type of column in database is 255
                             // default size will be 255 if 50 is not given 
	private String street;   // here is string but ib sql varchar will come 
	                         
	private String  city;    // here is string but ib sql varchar will come and default s
	...
	@Lob  //  it stands for large object , blob  
	private byte[] image;
